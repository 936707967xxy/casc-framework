 ...
 * 作者：ywzou <br>
 * 创建时间：2018年1月18日 <br>
 * 描述：质检复核任务监听 穿件后 create
 */
@Component("qcAuditTaskListener")
public class QcAuditTaskListener implements TaskListener {
	...
	public void notify(DelegateTask task) {
		...
		if (StringUtils.isNotBlank(applyId)) {
			...
			sql.append("and hp.ID_=#{procInstId} and hi.TASK_DEF_KEY_='qcCheck' ");
