 ...
 * 作者：ywzou <br>
 * 创建时间：2018年1月18日 <br>
 * 描述：终审任务监听 穿件后 create
 */
@Component("finalAuditTaskListener")
public class FinalAuditTaskListener implements TaskListener {
	private static final long serialVersionUID = -6500178349189118450L;
	...
	public void notify(DelegateTask task) {
		...
		if (StringUtils.isNotBlank(applyId)) {
			...
			sql.append("and hp.ID_=#{procInstId} and hi.TASK_DEF_KEY_='finalAudit' ");
