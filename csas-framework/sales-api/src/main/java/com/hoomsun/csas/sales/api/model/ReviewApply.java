...
public class ReviewApply {
    ...
    private String createEmployeeVal;
    ...
    public void setReconId(String reconId) {
        this.reconId = reconId == null ? null : reconId.trim();
    }
    ...
    public void setProcStatusVal(String procStatusVal) {
        this.procStatusVal = procStatusVal == null ? null : procStatusVal.trim();
    }
    ...
    public String getReviewTypeVal() {
        return reviewTypeVal;
    }

    public void setReviewTypeVal(String reviewTypeVal) {
        this.reviewTypeVal = reviewTypeVal == null ? null : reviewTypeVal.trim();
    }
    ...
    public void setSalesEmpId(String salesEmpId) {
        this.salesEmpId = salesEmpId == null ? null : salesEmpId.trim();
    }
    ...
    public void setSalesEmpName(String salesEmpName) {
        this.salesEmpName = salesEmpName == null ? null : salesEmpName.trim();
    }
