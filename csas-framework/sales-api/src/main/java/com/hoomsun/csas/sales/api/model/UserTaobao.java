...
public class UserTaobao {
	...
	private List<UserTaoBaoAddress> addresses;
	...
	public List<UserTaoBaoAddress> getAddresses() {
		return addresses;
	}

	public void setAddresses(List<UserTaoBaoAddress> addresses) {
