...
var ProcessDiagramGenerator = {	
	...
	init: function(){
		...
		this.activityDrawInstructions["startEvent"] = function(){
			...
			console.info("#### disX ### ： " + ProcessDiagramGenerator.disX);
			console.info("#### disY ### ： " + ProcessDiagramGenerator.disY);
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawNoneStartEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["startTimerEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawTimerStartEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, activityImpl.getProperty("name"));
		};
		...
		this.activityDrawInstructions["messageStartEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawMessageStartEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, activityImpl.getProperty("name"));
		};
		...
		this.activityDrawInstructions["startSignalEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawSignalStartEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, activityImpl.getProperty("name"));
		};
		...
		this.activityDrawInstructions["startMultipleEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawMultipleStartEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, activityImpl.getProperty("name"));
		};
		...
		this.activityDrawInstructions["intermediateSignalCatch"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawCatchingSignalEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, null);
		...
		this.activityDrawInstructions["intermediateMessageCatch"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawCatchingMessageEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, null);
      ...
      if (label)
		...
		this.activityDrawInstructions["intermediateMultipleCatch"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawCatchingMultipleEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, null);
      ...
      if (label)
		...
		this.activityDrawInstructions["intermediateSignalThrow"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawThrowingSignalEvent(x, y,  activityImpl.getWidth(), activityImpl.getHeight(), activityImpl.getProperty("name"));
      ...
      if (label)
		...
		this.activityDrawInstructions["intermediateMessageThrow"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawThrowingMessageEvent(x, y,  activityImpl.getWidth(), activityImpl.getHeight(), activityImpl.getProperty("name"));
      ...
      if (label)
		...
		this.activityDrawInstructions["intermediateMultipleThrow"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawThrowingMultipleEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), activityImpl.getProperty("name"));
      ...
      if (label)
		...
		this.activityDrawInstructions["intermediateThrowEvent"] = function() {
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawThrowingNoneEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), activityImpl.getProperty("name"));
      ...
      if (label)
		...
		this.activityDrawInstructions["endEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawNoneEndEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["errorEndEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawErrorEndEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), null);
      ...
      if (label)
		...
		this.activityDrawInstructions["messageEndEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawMessageEndEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), null);
      ...
      if (label)
		...
		this.activityDrawInstructions["signalEndEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawSignalEndEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), null);
      ...
      if (label)
		...
		this.activityDrawInstructions["multipleEndEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawMultipleEndEvent(x, y,activityImpl.getWidth(), activityImpl.getHeight(), null);
      ...
      if (label)
		...
		this.activityDrawInstructions["terminateEndEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawTerminateEndEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight());
      ...
      if (label)
		...
		this.activityDrawInstructions["errorStartEvent"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawErrorStartEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), activityImpl.getProperty("name"));
      ...
      if (label)
		...
		this.activityDrawInstructions["userTask"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawUserTask(activityImpl.getProperty("name"), x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["scriptTask"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawScriptTask(activityImpl.getProperty("name"), x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["serviceTask"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawServiceTask(activityImpl.getProperty("name"), x,y,activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["receiveTask"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawReceiveTask(activityImpl.getProperty("name"), x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["sendTask"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawSendTask(activityImpl.getProperty("name"), x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["manualTask"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawManualTask(activityImpl.getProperty("name"), x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["businessRuleTask"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawBusinessRuleTask(activityImpl.getProperty("name"), x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["exclusiveGateway"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawExclusiveGateway(x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["inclusiveGateway"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawInclusiveGateway(x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["parallelGateway"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawParallelGateway(x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["eventBasedGateway"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawEventBasedGateway(x, y, activityImpl.getWidth(), activityImpl.getHeight());
		};
		...
		this.activityDrawInstructions["boundaryTimer"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawCatchingTimerEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, null);
      ...
      if (label)
		...
		this.activityDrawInstructions["boundaryError"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawCatchingErrorEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, null);
    ...
    this.activityDrawInstructions["boundaryMessage"] = function(){
		...
		this.activityDrawInstructions["intermediateTimer"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawCatchingTimerEvent(x, y, activityImpl.getWidth(), activityImpl.getHeight(), isInterrupting, activityImpl.getProperty("name"));
		};
		...
		this.activityDrawInstructions["subProcess"] = function(){
			...
			if (isExpanded != undefined && isExpanded == false) {
			  processDiagramCanvas.drawCollapsedSubProcess(activityImpl.getProperty("name"), x,y,
					  activityImpl.getWidth(), activityImpl.getHeight(), isTriggeredByEvent);
			} else {
			  processDiagramCanvas.drawExpandedSubProcess(activityImpl.getProperty("name"),x,y,
					  activityImpl.getWidth(), activityImpl.getHeight(), isTriggeredByEvent);
			}
		...
		this.activityDrawInstructions["callActivity"] = function(){
			...
			var x = activityImpl.getX() - ProcessDiagramGenerator.disX;
			var y = activityImpl.getY() - ProcessDiagramGenerator.disY;
			processDiagramCanvas.drawCollapsedCallActivity(activityImpl.getProperty("name"), x,y, activityImpl.getWidth(), activityImpl.getHeight());
		};
	 ...
	 getActivitiLabel:function(activityImpl){
	   ...
	   */
	   ...
	   return {
	     ...
	     x: x + .5 + activityImpl.getWidth()/2,
	     y: y + .5 + activityImpl.getHeight() + ICON_PADDING,
	     width: 100,
	     height: 0
	   };
	},
		...
		var task1 = new $.AsyncQueue();
			...
			task1.add(sequenceFlows,function (task1, flow) {
				...
				for(var j in flow.xPointArray) {
					//画线
					var x = flow.xPointArray[j] - ProcessDiagramGenerator.disX;
					var y = flow.yPointArray[j] - ProcessDiagramGenerator.disY;
					waypoints[j] = {x: x, y: y};
				}
	...
	initProcessDiagramCanvas: function (processDefinitionDiagramLayout) {
		...
		var activities = processDefinitionDiagramLayout.activities;
		var activity = new ActivityImpl(activities[0]);
		minX =  activity.getX();
		maxX = activity.getX();
		minY = activity.getY();
		maxY = activity.getY();
		...
		if (diagramCanvas) {
			...
			this.disX = minX-40;
			this.disY = minY-40;
			console.info("#### disX   ： " + this.disX);
			console.info("#### disY   ： " + this.disY);
			diagramCanvas.init((maxX-minX + 100), (maxY-minY+100), processDefinitionDiagramLayout.processDefinition.id);
