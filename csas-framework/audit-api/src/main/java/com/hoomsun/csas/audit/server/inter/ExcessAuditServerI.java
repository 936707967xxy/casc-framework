 ...
 * 描述：
 */
public interface ExcessAuditServerI {
	public static final Integer PASSING = 1;// 通过
	public static final Integer ROLLBACK = 2;// 退回
	public static final Integer REJECT = 0;// 拒贷

	Json createExcessAudit(ExcessAudit excessAudit);

	Json updateExcessAudit(ExcessAudit excessAudit);

	Json deleteExcessAudit(String excessId);

	ExcessAudit findById(String excessId);
	 ...
	 * @return
	 */
	Json completeTask(String applyId, ExcessAudit excessAudit);
	...
	Json saveOrUpdateAudit(ExcessAudit excessAudit);
