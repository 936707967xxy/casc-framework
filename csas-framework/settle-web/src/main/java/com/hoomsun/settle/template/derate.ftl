...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882">
  <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
    ...
    <LastSaved>2018-02-07T01:47:07Z</LastSaved>
  </DocumentProperties>
  ...
  <Styles>
    ...
    <Style ss:ID="s57">
      ...
      <Font ss:FontName="宋体" x:CharSet="0" x:Family="Modern" ss:Size="10"/>
      <Interior/>
    </Style>
    <Style ss:ID="s58">
      <Alignment ss:Horizontal="Center"/>
  ...
  <Worksheet ss:Name="Sheet1">
    <Table ss:ExpandedColumnCount="16384" ss:ExpandedRowCount="${derateReport?size+2}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="13.5">
      <Column ss:Index="1" ss:StyleID="s51" ss:AutoFitWidth="0"/>
      <Column ss:Index="2" ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="136.5"/>
      ...
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="118.5"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="119.25"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="95.25"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="128.25"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Span="16348"/>
      <Column ss:Index="16371" ss:StyleID="s51" ss:Span="13"/>
      <Row>
        <Cell ss:StyleID="s59" ss:MergeAcross="20" ss:MergeDown="1">
      ...
      <Row ss:StyleID="s50" ss:Height="15.75">
        ...
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">逾期期数</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">逾期天数</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">应收本金</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">应收利息</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">应收本息</Data>
        </Cell>
        <Cell ss:StyleID="s54">
        ...
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">应收违罚息</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">逾期应收总额</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">逾期已收总额</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">提前还款应还金额</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">提前还款已还金额</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">实际减免金额</Data>
        </Cell>
        <Cell ss:StyleID="s54">
          <Data ss:Type="String">备注</Data>
        </Cell>
      </Row>
	  <#if derateReport?exists && derateReport??>
	  <#list derateReport as item>
      <Row ss:StyleID="s50">
        <Cell ss:StyleID="s55">
          <Data ss:Type="Number">${item_index+1}</Data>
        </Cell>
        <Cell ss:StyleID="s56">
          <Data ss:Type="String">${item.shouldDate!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
        ...
        <Cell ss:StyleID="s55">
          <Data ss:Type="Number">${item.overdueNum!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="Number">${item.overdueDays!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="Number">${item.shouldCapi!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="Number">${item.shouldInte!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="Number">${item.shouldPrincipal!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="Number">${item.receivePenalty!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="Number">${item.receiveInterest!''}</Data>
        </Cell>
        <Cell ss:StyleID="s58">
          <Data ss:Type="Number">${item.receivePenaltyInterest!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="String">${item.receiveTotalMoney!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="String">${item.receivedMoney!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="String">${item.advanceShould!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="String">${item.advanceMoney!''}</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="String">${item.advanceReduce!''}</Data>
        </Cell>
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">${item.applicationDesc!''}</Data>
        </Cell>
      </Row>
	  </#list>
	  </#if>
    ...
    <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
      ...
      <Panes>
        <Pane>
          ...
          <RangeSelection>R1C1:R2C21</RangeSelection>
        </Pane>
      </Panes>
