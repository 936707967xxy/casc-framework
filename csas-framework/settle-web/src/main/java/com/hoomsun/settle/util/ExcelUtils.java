 ...
 */
package com.hoomsun.settle.util;
 ...
 * 创建时间：2018年2月1日 <br>
 * 描述：导出excel
 * http://blog.csdn.net/younglee16/article/details/78997950
 */
public class ExcelUtils {
	    ...
	    // 传入要导入的数据  
	    public ExcelUtils(String title,String[] rowName,List<Object[]>  dataList,HttpServletResponse  response){  
	        this.title=title;  
