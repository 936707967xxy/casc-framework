...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882">
  <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
    ...
    <LastSaved>2018-02-07T08:17:07Z</LastSaved>
  </DocumentProperties>
  ...
  <Worksheet ss:Name="Sheet1">
    <Table ss:ExpandedColumnCount="16384" ss:ExpandedRowCount="${LoanInfo?size+2}" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="13.5">
      <Column ss:Index="1" ss:StyleID="s51" ss:AutoFitWidth="0"/>
      <Column ss:Index="2" ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="119.25"/>
      ...
      <Column ss:StyleID="s51" ss:AutoFitWidth="0"/>
      ...
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="87"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="96"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="120.75"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="129"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="108.75"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="159"/>
      <Column ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="130.5" ss:Span="1"/>
      <Column ss:Index="19" ss:StyleID="s51" ss:AutoFitWidth="0" ss:Width="124.5"/>
      ...
      <Column ss:StyleID="s52" ss:AutoFitWidth="0" ss:Span="16352"/>
      <Column ss:Index="16378" ss:StyleID="s52" ss:Span="6"/>
      <Row>
        <Cell ss:StyleID="s59" ss:MergeAcross="23" ss:MergeDown="1">
      ...
      <Row ss:StyleID="s50" ss:Height="15.75">
        ...
        <Cell ss:StyleID="s56">
          <Data ss:Type="String">合同状态</Data>
        </Cell>
        <Cell ss:StyleID="s56">
          <Data ss:Type="String">开户行</Data>
        </Cell>
        <Cell ss:StyleID="s56">
          <Data ss:Type="String">签约门店</Data>
        </Cell>
        <Cell ss:StyleID="s56">
          <Data ss:Type="String">银行账户</Data>
        </Cell>
        <Cell ss:StyleID="s56">
        ...
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">产品利率</Data>
        </Cell>
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">签约产品</Data>
        </Cell>
        <Cell ss:StyleID="s57">
        ...
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">申请金额</Data>
        </Cell>
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">放款日期</Data>
        </Cell>
        <Cell ss:StyleID="s58">
          <Data ss:Type="String">开始还款日期</Data>
        </Cell>
        <Cell ss:StyleID="s58">
          <Data ss:Type="String">还款结束日期</Data>
        </Cell>
        <Cell ss:StyleID="s58">
          <Data ss:Type="String">签约日期</Data>
        </Cell>
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">月还款额</Data>
        </Cell>
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">服务费用</Data>
        </Cell>
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">放款人员</Data>
        </Cell>
        <Cell ss:StyleID="s57">
          <Data ss:Type="String">处理意见</Data>
        </Cell>
        <Cell ss:StyleID="s55">
          <Data ss:Type="String">是否线上</Data>
        </Cell>
      </Row>
	 <#if LoanInfo?exists && LoanInfo??>  
	 <#list LoanInfo as item>  
      <Row>
        <Cell ss:StyleID="s51">
        ...
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.custName!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.idNumber!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.conStatus!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.bank!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.signStore!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.bankNo!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.bankPhoneNo!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.productPeriod!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
        ...
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.loanAmount!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.conAmount!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.applyMoney!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.loanDate!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.startTime!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.endTime!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.signTime!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.monthMoney!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.sumFee!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.handleEmpName!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.handleOptionVal!''}</Data>
        </Cell>
        <Cell ss:StyleID="s51">
          <Data ss:Type="String">${item.isOnline!''}</Data>
        </Cell>
      </Row>
	   </#list>  
      </#if> 
    ...
    <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
      ...
      <LeftColumnVisible>13</LeftColumnVisible>
      ...
      <Panes>
        <Pane>
          ...
          <RangeSelection>R4C24</RangeSelection>
        </Pane>
      </Panes>
