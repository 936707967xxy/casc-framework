...
public class ComponentsTest {
	...
	public void initData() {
		String result = FileUtil.redFile("D:\\SVN\\CSAS_178\\trunk\\csas-framework\\settle-web\\src\\main\\resources\\routes.json");
	...
	public void getSerialNumber() {
		for (int i = 0; i < 100; i++) {
			new SerialNumberThread(serialnumberServer).run();
		}
	}
	...
	public class SerialNumberThread implements Runnable{
		...
		public SerialNumberThread(SerialNumberServerI serialnumberServer) {
			this.serialnumberServer = serialnumberServer;
		}

		@Override
		public void run() {
			String serialnumber = serialnumberServer.createSerialNumber("2", "ZAXM");
			System.out.println("生成测试编号=============================:" + serialnumber);
		}
